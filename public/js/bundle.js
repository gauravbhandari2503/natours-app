...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_login) {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('/api/v1/users/login', _login);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.patch('/api/v1/users/change-password', data);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('/api/v1/users/signup', userInfo);
...
var displayMap = function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LngLatBounds(); // area that will be displayed in the map
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend map bounds to include current location - zooming effect - fitBounds zooms the map to fit our marker
...
var stripe = Stripe('pk_test_51K68pZSIz2g01x24yEqpXWHXDkk5BQMGuTuQRDkaKZ674cU3pDf1U9JVpvfi7NvRhNtfQ6SdwZrCsU80E4Nrt2UZ00U4BYOVd3');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(session); // 2) Create the checkout form + process or charge the credit card
...
if (updateUserPassword) {
  updateUserPassword.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updatePassword)(userData);
  });
}
